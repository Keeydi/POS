                        ...
                        <div class="flex items-center">
                            ...
                            <div class="ml-5 w-0 flex-1">
                                <dl>
                                    ...
                                    <dd class="text-2xl md:text-3xl font-bold text-gray-900 mt-1"><?php echo e($stats['today_orders']); ?></dd>
                                </dl>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="flex items-center">
                            ...
                            <div class="ml-5 w-0 flex-1">
                                <dl>
                                    ...
                                    <dd class="text-2xl md:text-3xl font-bold text-gray-900 mt-1">₱<?php echo e(number_format($stats['today_sales'], 2)); ?></dd>
                                </dl>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="flex items-center">
                            ...
                            <div class="ml-5 w-0 flex-1">
                                <dl>
                                    ...
                                    <dd class="text-2xl md:text-3xl font-bold text-gray-900 mt-1"><?php echo e($stats['open_tables']); ?></dd>
                                </dl>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="flex items-center">
                            ...
                            <div class="ml-5 w-0 flex-1">
                                <dl>
                                    ...
                                    <dd class="text-2xl md:text-3xl font-bold text-gray-900 mt-1"><?php echo e($stats['pending_orders']); ?></dd>
                                </dl>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-6 md:gap-8 flex-1 min-h-0">
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $areas; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $area): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <div class="flex flex-col min-h-0">
                                <h4 class="text-lg md:text-xl font-semibold text-gray-700 mb-4"><?php echo e($area->name); ?></h4>
                                    ...
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $area->tables; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $table): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <a href="<?php echo e(route('pos.table', $table)); ?>" 
                                           ...
                                           <?php echo e($table->status === 'occupied' ? 'bg-red-100 border-red-400 hover:bg-red-200' : 'bg-green-100 border-green-400 hover:bg-green-200'); ?>">
                                            <div class="text-sm md:text-base font-semibold"><?php echo e($table->name); ?></div>
                                            <div class="text-xs md:text-sm text-gray-600 mt-1 capitalize"><?php echo e($table->status); ?></div>
                                        </a>
