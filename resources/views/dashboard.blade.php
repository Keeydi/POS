                        ...
                        <div class="flex items-center">
                            ...
                            <div class="ml-5 w-0 flex-1">
                                <dl>
                                    ...
                                    <dd class="text-lg font-medium text-gray-900">₱{{ number_format($stats['today_sales'], 2) }}</dd>
                                </dl>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="flex items-center">
                            ...
                            <div class="ml-5 w-0 flex-1">
                                <dl>
                                    ...
                                    <dd class="text-lg font-medium text-gray-900">{{ $stats['open_tables'] }}</dd>
                                </dl>
                            </div>
                        </div>
                    </div>
                ...
                <div class="p-6">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                        @foreach($areas as $area)
                            <div>
                                <h4 class="font-semibold text-gray-700 mb-2">{{ $area->name }}</h4>
                                    ...
                                    @foreach($area->tables as $table)
                                        <a href="{{ route('pos.table', $table) }}" 
                                           ...
                                           hover:bg-gray-100 transition">
                                            <div class="text-xs font-medium">{{ $table->name }}</div>
                                            <div class="text-xs text-gray-500">{{ $table->status }}</div>
                                        </a>
                                    @endforeach
                                </div>
                            </div>
